...
Route::middleware(['auth'])->group(function () {
    ...
    route::get('/upload_pan_document', [PancardController::class, 'upload_pan_document'])->name('upload_pan_document');
    ...
    route::get('/verify_pan_number', [PancardController::class, 'Verify_pancard_form'])->name('verify_pan_number');

    route::get('/pan_data_review', [PancardController::class, 'pan_data_reviewform'])->name('pan_data_review');
    route::get('/pan_verification_completed', [PancardController::class, 'pan_verification_comp'])->name('pan_verification_completed');

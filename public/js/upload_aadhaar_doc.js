document.addEventListener('DOMContentLoaded', () => {
    ...
    // When the Gallery button is clicked, trigger the file input click
    uploadFromGalleryBtn.addEventListener('click', () => {
        fileInput.click(); // This will trigger the file input dialog
    });

    // Handle the file selection after the input dialog is opened
    ...
    submitButton.addEventListener('click', (event) => {
        ...
        if (!fileInput.files.length) {
            ...
            errorMessageDiv.innerText = 'Please upload an Aadhaar card image.';

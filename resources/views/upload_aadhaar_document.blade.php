...
<div class="upload-card aadhaar">
    ...
    <div class="secondary-card mb-4">
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-primary w-50"><i class="bi bi-camera-fill me-1"></i>Take Photo</button>
            <button class="btn btn-light w-50"><i class="bi bi-folder-fill me-1"></i>Gallery</button>
        </div>
    </div>
    ...
    {{-- <div class="d-flex gap-3">
            <button class="btn btn-light border w-50">Cancel</button>
            <button class="btn btn-success w-50">Continue</button>
        </div> --}}

    <div class="d-flex gap-3">
        <button class="btn btn-light border w-50">Cancel</button>

        <a href="{{ route('aadhaar1') }}" class="btn btn-success w-50">
            Continue
        </a>
    </div>

                    ...
                    <form id="aadhaarForm">
                        ...
                        @php
                            ...
                            $dob =
                                $user->date_of_birth ??
                                null ??
                                ($customer->date_of_birth ?? null ?? ($extracted['date_of_birth'] ?? null ?? 'N/A'));
                            $address =
                                $user->address ??
                                null ??
                                ($customer->address ?? null ?? ($extracted['address'] ?? null ?? 'N/A'));
                            $gender =
                                $user->gender ??
                                null ??
                                ($customer->gender ?? null ?? ($extracted['gender'] ?? null ?? 'N/A'));
                            $phone =
                                $user->phone ??
                                null ??
                                ($customer->phone ?? null ?? ($extracted['phone'] ?? null ?? 'N/A'));
                            $email =
                                $user->email ??
                                null ??
                                ($customer->email ?? null ?? ($extracted['email'] ?? null ?? 'N/A'));
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group-field">
                                <input type="text" class="form-control" id="dob" value="{{ $dobFormatted }}"
                                    readonly>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="gender" disabled>
                                <option value="Male"
                                    {{ $gender == 'Male' || $gender == 'M' || $gender == 'MALE' ? 'selected' : '' }}>Male
                                </option>
                                <option value="Female"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group-field">
                                <input type="text" class="form-control" id="aadhaar" value="{{ $maskedAadhaar }}"
                                    readonly>
